...
SITES = [
    ...
    {
        "name": "DuckDuckGo",
        "url": "https://duckduckgo.com/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "Yandex",
        "url": "https://yandex.com/profile/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        "name": "Baidu",
        "url": "https://baidu.com/p/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        "name": "Startpage",
        "url": "https://www.startpage.com/do/search?q={username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        "name": "Brave Search",
        "url": "https://search.brave.com/search?q={username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        "name": "Ecosia",
        "url": "https://www.ecosia.org/search?q={username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        "name": "Qwant",
        "url": "https://www.qwant.com/?q={username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        "name": "Mojeek",
        "url": "https://www.mojeek.com/search?q={username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "Opacity",
        "url": "https://opacity.media/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "arXiv",
        "url": "https://arxiv.org/search/?searchtype={username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        "name": "SSRN",
        "url": "https://www.ssrn.com/author={username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "Pluralsight",
        "url": "https://app.pluralsight.com/profile/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        "name": "Skillshare",
        "url": "https://www.skillshare.com/@{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        "name": "FutureLearn",
        "url": "https://www.futurelearn.com/profiles/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        "name": "OpenLearn",
        "url": "https://openlearnopenacademy.open.edu/printf/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "Epic Games (new)",
        "url": "https://www.epicgames.com/account/en-US/profile",
        "check_type": "custom",
    },
    {
        "name": "Battle.net",
        "url": "https://account.battle.net/profile/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    },
    {
        ...
        "url": "https://socialclub.rockstargames.com/stats/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        "name": "EA Origin",
        "url": "https://www.ea.com/sign-in?redirectTo={username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        ...
        "url": "https://accounts.nintendo.com/login?username={username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "Terraria (alt)",
        "url": "https://terraria.org/forum/home/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        "name": "Factorio",
        "url": "https://forums.factorio.com/u/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        "name": "Stardew Valley",
        "url": "https://stardewvalleywiki.com/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "Jamendo",
        "url": "https://www.jamendo.com/@{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "ViewBug",
        "url": "https://viewbug.com/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "Photobucket",
        "url": "https://photobucket.com/user/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "Zenfolio",
        "url": "https://{username}.zenfolio.com",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "Wix",
        "url": "https://{username}.wixsite.com/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "Squarespace",
        "url": "https://www.squarespace.com/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "Buttondown",
        "url": "https://buttondown.email/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        "name": "ConvertKit",
        "url": "https://convertkit.com/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "ENS",
        "url": "https://app.ens.domains/name/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "Blockscout",
        "url": "https://blockscout.com/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "Peloton",
        "url": "https://members.onepeloton.com/users/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "Zwift",
        "url": "https://www.zwift.com/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        "name": "Komoot",
        "url": "https://www.komoot.com/user/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "Podbean",
        "url": "https://podbean.com/podcast/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "Transistor",
        "url": "https://transistor.fm/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        "name": "Simplecast",
        "url": "https://feeds.simplecast.com/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        "name": "Podcast Index",
        "url": "https://podcastindex.org/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "Kbin",
        "url": "https://kbin.social/u/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "Pleroma",
        "url": "https://pleroma.site/@{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        "name": "WriteFreely",
        "url": "https://writefreely.org/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        "name": "Bookwyrm",
        "url": "https://bookwyrm.social/users/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        "name": "Friendica",
        "url": "https://friendica.com/profile/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        "name": "Diaspora",
        "url": "https://joindiaspora.com/u/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "WeChat",
        "url": "https://mp.weixin.qq.com/username={username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "Xiaohongshu",
        "url": "https://www.xiaohongshu.com/user/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "Toutiao",
        "url": "https://www.toutiao.com/user/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        "name": "Kuaishou",
        "url": "https://www.kuaishou.com/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "Daum",
        "url": "https://blog.daum.net/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    {
        "name": "KakaoTalk (alt)",
        "url": "https://story.kakao.com/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    # ============================================
    {
        ...
        "url": "https://www.coffeemeetsbagel.com/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        "name": "PlentyOfFish (alt)",
        "url": "https://www.pof.com/profile/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    ...
    # ============================================
    # Niche & Entertainment (NEW)
    # ============================================
    {
        "name": "MyAnimeList (alt)",
        "url": "https://myanimelist.net/profile/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    ...
    {
        "name": "Backloggd",
        "url": "https://backloggd.com/profile/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
    {
        "name": "HowLongToBeat",
        "url": "https://howlongtobeat.com/{username}",
        "check_type": "status_code",
        "match": [200],
        "exclude": [404],
    },
